...
router.get('/me', requireAuth, asyncRoute(async (req, res) => {
  const user = await db.get('SELECT id, email, name, account_type, avatar_url, bio, location_city, location_state, home_lat, home_lng, home_label, humidor_sheet_url, created_at FROM users WHERE id = ?', [req.user.id]);
